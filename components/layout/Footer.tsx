...
import { Printer, MapPin, Phone, Mail, Clock, Instagram, Facebook, Twitter } from 'lucide-react'
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center gap-2.5 mb-5">
              <div className="w-10 h-10 bg-pink rounded-xl flex items-center justify-center shadow-lg shadow-pink/30">
